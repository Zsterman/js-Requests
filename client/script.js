...
// CODE HERE
    function sayByeColor(event){
        sayHelloButton.style.backgroundColor = ('#EFEFEF');
        sayHelloButton.style.color = ('black');
    }

    sayHelloButton.addEventListener('mouseout', sayByeColor);
...
// CODE HERE
const request = () => {
    axios.get('http://localhost:3000/query-test/?anything=whatever')
    .then(res => 
        console.log(res.data));
}
